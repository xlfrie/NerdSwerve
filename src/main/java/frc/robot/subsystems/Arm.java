...
public class Arm extends SubsystemBase {
    ...
    public Arm() {
        ...
        armRightMotor.configureMotor(ArmConstants.kRotorToSensorRatio, ArmConstants.kOpenLoopRampRate,
                ...
                ArmConstants.kIdleBrake);
        armRightMotor.configurePIDF(ArmConstants.kP, ArmConstants.kI, ArmConstants.kD, ArmConstants.kIz,
                ArmConstants.kF, ArmConstants.kMinOutput, ArmConstants.kMaxOutput);
